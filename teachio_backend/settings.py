...
SECRET_KEY = config(
    'SECRET_KEY', default='django-insecure-i+eb%+cn!=+4e5(q4*%g+^8qhpspj_5^ow_7i*qog%=c2hg5kl')
...
ROOT_URLCONF = 'teachio_backend.urls'
...
WSGI_APPLICATION = 'teachio_backend.wsgi.application'
